...
- (void)viewDidLoad
{
    ...
    [leftBtn setFrame:CGRectMake(10, 40, 34, 34)];
    ...
    [rightBtn setFrame:CGRectMake(270, 40, 34, 34)];
    ...
    rootImageView = [[UIImageView alloc ] initWithFrame:CGRectMake(20, 100, 280, 280)];
